...
_queue_block    = [MAX_QUEUE] * 4
_ev_queue_block = [MAX_QUEUE] * 4 + [1.0, float(MIN_GREEN_STEPS * 4)]
...
_obs_high = np.array(
    _queue_block + _ev_queue_block +          # intersection 1
    _queue_block + _ev_queue_block +          # intersection 2
